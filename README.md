...
The applicants information regarding their income range, homeownership status and employment status has a significant impact on the loan approval status me as an interesting one and I want to explore that in the datasets.

## Blog:

https://medium.com/@hthdonghuy207/prosper-loan-data-analysis-59cd400f8aa9

## Requirements package library
...
HuyTDD.ipynb: code for the analysis.
